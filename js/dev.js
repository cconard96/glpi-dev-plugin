...
class GlpiDevClassViewer extends GlpiDevView {
    ...
    static init() {
        if ($("#classview-container").length > 0) {
            ...
            $("#classview-container .info-container").on('click', '.dbschema-link-btn', (e) => {
                GlpiDevDBViewer.onDBSchemaLinkBtnClick(e);
            });
            $("#classview-container .info-container").on('click', '.classview-link-btn', (e) => {
                GlpiDevClassViewer.onClassViewLinkBtnClick(e);
            });
...
class GlpiDevDBViewer extends GlpiDevView {
    ...
    static init() {
        if ($("#dbschemaview-container").length > 0) {
            ...
            $("#dbschemaview-container .info-container").on('click', '.dbschema-link-btn', (e) => {
                GlpiDevDBViewer.onDBSchemaLinkBtnClick(e);
            });
            $("#dbschemaview-container .info-container").on('click', '.classview-link-btn', (e) => {
                GlpiDevClassViewer.onClassViewLinkBtnClick(e);
            });
            if ($.urlParam('db_name')) {
